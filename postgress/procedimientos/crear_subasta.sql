...
ALTER PROCEDURE crear_subasta(INT, VARCHAR, TIMESTAMP, TEXT) SET SCHEMA casa_subastas_schema;

ALTER PROCEDURE crear_subasta(INT, VARCHAR, TIMESTAMP, TEXT) OWNER TO app;
